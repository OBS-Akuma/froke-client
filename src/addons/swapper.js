...
const initResourceSwapper = () => {
  protocol.registerFileProtocol("frokeclient", (request, callback) =>
    callback({ path: request.url.replace("frokeclient://", "") })
  );
  ...
  let folder_regex_generator = "frokeclient[\\\\/]swapper[\\\\/]assets[\\\\/](";
