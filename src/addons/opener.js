let git_base = "https://raw.githubusercontent.com/ObsidianClient/KirkaScripts/refs/heads/main/";
...
function createDropdown() {
  ...
  const options = [
    ...
    { value: "Chest_Christmas", text: "Christmas" },
  ...
  select.addEventListener("change", async () => {
    ...
    else if (value == "Chest_Christmas") {
      let customchestlist = [
        { chestid: "be1fec80-d4e4-47ab-9f73-9f5622e6e905", name: "Christmas" },
      ];
      start_chests_input(customchestlist);
    } 
